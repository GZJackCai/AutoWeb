...
public interface UserFavoriteMapper {
	 ...
	 * @mbggenerated  Sun May 11 15:20:09 CST 2014
	 */
	int updateByExampleSelective(@Param("record") UserFavorite record,
			@Param("example") UserFavoriteExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table user_favorite
	 * @mbggenerated  Sun May 11 15:20:09 CST 2014
	 */
	int updateByExample(@Param("record") UserFavorite record,
			@Param("example") UserFavoriteExample example);
