...
public interface widgettype_autovolume_rMapper {
	 ...
	 * @mbggenerated  Wed May 14 23:52:52 CST 2014
	 */
	List<widgettype_autovolume_r> selectByExample(
			widgettype_autovolume_rExample example);
	...
	int updateByExampleSelective(
			@Param("record") widgettype_autovolume_r record,
			@Param("example") widgettype_autovolume_rExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table widgettype_autovolume_r
	 * @mbggenerated  Wed May 14 23:52:52 CST 2014
	 */
	int updateByExample(@Param("record") widgettype_autovolume_r record,
			@Param("example") widgettype_autovolume_rExample example);
}