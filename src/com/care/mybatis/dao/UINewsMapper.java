...
public interface UINewsMapper {
	 ...
	 * @mbggenerated  Sun May 11 15:20:09 CST 2014
	 */
	int updateByExampleSelective(@Param("record") UINews record,
			@Param("example") UINewsExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table ui_news
	 * @mbggenerated  Sun May 11 15:20:09 CST 2014
	 */
	int updateByExampleWithBLOBs(@Param("record") UINews record,
			@Param("example") UINewsExample example);
	 ...
	 * @mbggenerated  Sun May 11 15:20:09 CST 2014
	 */
	int updateByExample(@Param("record") UINews record,
			@Param("example") UINewsExample example);
